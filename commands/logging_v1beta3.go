...
func Logging_v1beta3_ProjectsEntriesList(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1beta3/projects/{projectsId}/entries:list", "+") {
	...
	service := api_client.NewProjectsEntriesService(api_service)
