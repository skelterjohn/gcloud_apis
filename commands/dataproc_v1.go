...
import (
	...
	api_client "github.com/skelterjohn/gcloud_apis/clients/dataproc/v1"
...
func Dataproc_v1_ProjectsRegionsClustersCreate(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1/projects/{projectId}/regions/{region}/clusters", "+") {
	...
	call := service.Create(param_projectId, param_region,
		request,
	)
...
func Dataproc_v1_ProjectsRegionsClustersDelete(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1/projects/{projectId}/regions/{region}/clusters/{clusterName}", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
	...
	param_clusterName, err := commands_util.ConvertValue_string(paramValues[2])
	if err != nil {
		return err
	}

	call := service.Delete(param_projectId, param_region, param_clusterName)
...
func Dataproc_v1_ProjectsRegionsClustersDiagnose(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1/projects/{projectId}/regions/{region}/clusters/{clusterName}:diagnose", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
	...
	call := service.Diagnose(param_projectId, param_region, param_clusterName,
		request,
	)
...
func Dataproc_v1_ProjectsRegionsClustersGet(context Context, args ...string) error {
	...
	call := service.Get(param_projectId, param_region, param_clusterName)
...
func Dataproc_v1_ProjectsRegionsClustersList(context Context, args ...string) error {
...
func Dataproc_v1_ProjectsRegionsClustersPatch(context Context, args ...string) error {
	...
	call := service.Patch(param_projectId, param_region, param_clusterName,
		request,
	)
...
func Dataproc_v1_ProjectsRegionsJobsCancel(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1/projects/{projectId}/regions/{region}/jobs/{jobId}:cancel", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
	...
	call := service.Cancel(param_projectId, param_region, param_jobId,
		request,
	)
...
func Dataproc_v1_ProjectsRegionsJobsDelete(context Context, args ...string) error {
	...
	call := service.Delete(param_projectId, param_region, param_jobId)
...
func Dataproc_v1_ProjectsRegionsJobsGet(context Context, args ...string) error {
	...
	call := service.Get(param_projectId, param_region, param_jobId)
...
func Dataproc_v1_ProjectsRegionsJobsList(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1/projects/{projectId}/regions/{region}/jobs", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Dataproc_v1_ProjectsRegionsJobsSubmit(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1/projects/{projectId}/regions/{region}/jobs:submit", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
	...
	call := service.Submit(param_projectId, param_region,
		request,
	)
...
func Dataproc_v1_ProjectsRegionsOperationsCancel(context Context, args ...string) error {
	...
	service := api_client.NewProjectsRegionsOperationsService(api_service)
...
func Dataproc_v1_ProjectsRegionsOperationsDelete(context Context, args ...string) error {
...
func Dataproc_v1_ProjectsRegionsOperationsGet(context Context, args ...string) error {
...
func Dataproc_v1_ProjectsRegionsOperationsList(context Context, args ...string) error {
