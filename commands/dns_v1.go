...
import (
	...
	api_client "github.com/skelterjohn/gcloud_apis/clients/dns/v1"
...
func Dns_v1_ChangesCreate(context Context, args ...string) error {

	usageFunc := func() {
		usageBits := fmt.Sprintf("gcloud_apis %s", context.InvocationMethod)
		var pathParams []string
		pathParams = append(pathParams, commands_util.AngrySnakes("project"))
		pathParams = append(pathParams, commands_util.AngrySnakes("managedZone"))

		if len(pathParams) != 0 {
			if strings.Contains("{project}/managedZones/{managedZone}/changes", "+") {
	...
	service := api_client.NewChangesService(api_service)
...
func Dns_v1_ChangesGet(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		pathParams = append(pathParams, commands_util.AngrySnakes("project"))
		pathParams = append(pathParams, commands_util.AngrySnakes("managedZone"))
		pathParams = append(pathParams, commands_util.AngrySnakes("changeId"))

		if len(pathParams) != 0 {
			if strings.Contains("{project}/managedZones/{managedZone}/changes/{changeId}", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Dns_v1_ChangesList(context Context, args ...string) error {
	...
	if value, ok := flagValues["sortBy"]; ok {
		query_sortBy, err := commands_util.ConvertValue_string(value)
		if err != nil {
			return err
		}
		call.SortBy(query_sortBy)
	}
	if value, ok := flagValues["sortOrder"]; ok {
		query_sortOrder, err := commands_util.ConvertValue_string(value)
		if err != nil {
			return err
		}
...
func Dns_v1_ManagedZonesCreate(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{project}/managedZones", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Dns_v1_ManagedZonesDelete(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{project}/managedZones/{managedZone}", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Dns_v1_ManagedZonesGet(context Context, args ...string) error {
...
func Dns_v1_ManagedZonesList(context Context, args ...string) error {
...
func Dns_v1_ProjectsGet(context Context, args ...string) error {
...
func Dns_v1_ResourceRecordSetsList(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{project}/managedZones/{managedZone}/rrsets", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
	...
	service := api_client.NewResourceRecordSetsService(api_service)
	...
	if value, ok := flagValues["type"]; ok {
		query_type, err := commands_util.ConvertValue_string(value)
		if err != nil {
			return err
		}
