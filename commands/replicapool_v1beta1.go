...
import (
	...
	api_client "github.com/skelterjohn/gcloud_apis/clients/replicapool/v1beta1"
...
func Replicapool_v1beta1_PoolsDelete(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		pathParams = append(pathParams, commands_util.AngrySnakes("poolName"))

		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/pools/{poolName}", "+") {
...
func Replicapool_v1beta1_PoolsInsert(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/pools", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Replicapool_v1beta1_PoolsResize(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/pools/{poolName}/resize", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Replicapool_v1beta1_PoolsUpdatetemplate(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/pools/{poolName}/updateTemplate", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Replicapool_v1beta1_ReplicasDelete(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		pathParams = append(pathParams, commands_util.AngrySnakes("zone"))
		pathParams = append(pathParams, commands_util.AngrySnakes("poolName"))
		pathParams = append(pathParams, commands_util.AngrySnakes("replicaName"))

		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/pools/{poolName}/replicas/{replicaName}", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Replicapool_v1beta1_ReplicasList(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/pools/{poolName}/replicas", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Replicapool_v1beta1_ReplicasRestart(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/pools/{poolName}/replicas/{replicaName}/restart", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
