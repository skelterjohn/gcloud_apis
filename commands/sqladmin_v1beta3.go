...
import (
	...
	api_client "github.com/skelterjohn/gcloud_apis/clients/sqladmin/v1beta3"
...
func Sql_v1beta3_BackupRunsGet(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		pathParams = append(pathParams, commands_util.AngrySnakes("backupConfiguration"))
		pathParams = append(pathParams, commands_util.AngrySnakes("dueTime"))

		if len(pathParams) != 0 {
			if strings.Contains("projects/{project}/instances/{instance}/backupRuns/{backupConfiguration}", "+") {
...
func Sql_v1beta3_InstancesClone(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("projects/{project}/instances/clone", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
	...
	var response *api_client.InstancesCloneResponse
	response, err = call.Do()
	if err != nil {
		return err
	}
...
func Sql_v1beta3_InstancesPromoteReplica(context Context, args ...string) error {
	...
	var response *api_client.InstancesPromoteReplicaResponse
	response, err = call.Do()
	if err != nil {
		return err
	}
...
func Sql_v1beta3_InstancesResetSslConfig(context Context, args ...string) error {
	...
	var response *api_client.InstancesResetSslConfigResponse
	response, err = call.Do()
	if err != nil {
		return err
	}
...
func Sql_v1beta3_InstancesSetRootPassword(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("projects/{project}/instances/{instance}/setRootPassword", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
	...
	var response *api_client.InstancesSetRootPasswordResponse
	response, err = call.Do()
	if err != nil {
		return err
	}
...
func Sql_v1beta3_OperationsGet(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("projects/{project}/instances/{instance}/operations/{operation}", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Sql_v1beta3_OperationsList(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("projects/{project}/instances/{instance}/operations", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Sql_v1beta3_SslCertsDelete(context Context, args ...string) error {
	...
	var response *api_client.SslCertsDeleteResponse
	response, err = call.Do()
	if err != nil {
		return err
	}
