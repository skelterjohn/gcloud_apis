...
import (
	...
	api_client "github.com/skelterjohn/gcloud_apis/clients/resourceviews/v1beta1"
...
func Resourceviews_v1beta1_RegionViewsAddresources(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		pathParams = append(pathParams, commands_util.AngrySnakes("resourceViewName"))

		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/regions/{region}/resourceViews/{resourceViewName}/addResources", "+") {
...
func Resourceviews_v1beta1_RegionViewsDelete(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/regions/{region}/resourceViews/{resourceViewName}", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Resourceviews_v1beta1_RegionViewsInsert(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/regions/{region}/resourceViews", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Resourceviews_v1beta1_RegionViewsListresources(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/regions/{region}/resourceViews/{resourceViewName}/resources", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Resourceviews_v1beta1_RegionViewsRemoveresources(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/regions/{region}/resourceViews/{resourceViewName}/removeResources", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Resourceviews_v1beta1_ZoneViewsAddresources(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/resourceViews/{resourceViewName}/addResources", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Resourceviews_v1beta1_ZoneViewsDelete(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/resourceViews/{resourceViewName}", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Resourceviews_v1beta1_ZoneViewsInsert(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/resourceViews", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Resourceviews_v1beta1_ZoneViewsListresources(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/resourceViews/{resourceViewName}/resources", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Resourceviews_v1beta1_ZoneViewsRemoveresources(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("{projectName}/zones/{zone}/resourceViews/{resourceViewName}/removeResources", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
