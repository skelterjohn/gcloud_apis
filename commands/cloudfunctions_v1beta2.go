...
import (
	...
	api_client "github.com/skelterjohn/gcloud_apis/clients/cloudfunctions/v1beta2"
...
func Cloudfunctions_v1beta2_OperationsGet(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1beta2/{+name}", "+") {
...
func Cloudfunctions_v1beta2_OperationsList(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1beta2/operations", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
...
func Cloudfunctions_v1beta2_ProjectsLocationsFunctionsCall(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1beta2/{+name}:call", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
	...
	service := api_client.NewProjectsLocationsFunctionsService(api_service)
...
func Cloudfunctions_v1beta2_ProjectsLocationsFunctionsCreate(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1beta2/{+location}/functions", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
		...
		fmt.Fprintf(os.Stderr, "Usage:\n\t%s\n", usageBits)
		commands_util.PrintRequestExample(&api_client.CloudFunction{})
	...
	request := &api_client.CloudFunction{}
	if len(args) == 2 {
		err = commands_util.PopulateRequestFromFilename(&request, args[1])
		if err != nil {
			return err
...
func Cloudfunctions_v1beta2_ProjectsLocationsFunctionsDelete(context Context, args ...string) error {
...
func Cloudfunctions_v1beta2_ProjectsLocationsFunctionsGet(context Context, args ...string) error {
...
func Cloudfunctions_v1beta2_ProjectsLocationsFunctionsList(context Context, args ...string) error {
...
func Cloudfunctions_v1beta2_ProjectsLocationsFunctionsUpdate(context Context, args ...string) error {
...
func Cloudfunctions_v1beta2_ProjectsLocationsList(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1beta2/{+name}/locations", "+") {
				usageBits += " @" + strings.Join(pathParams, "@")
			} else {
				usageBits += " " + strings.Join(pathParams, "/")
			}
