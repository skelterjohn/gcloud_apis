...
import (
	...
	api_client "github.com/skelterjohn/gcloud_apis/clients/cloudresourcesearch/v1"
...
func Cloudresourcesearch_v1_ResourcesSearch(context Context, args ...string) error {
	...
	usageFunc := func() {
		...
		if len(pathParams) != 0 {
			if strings.Contains("v1/resources:search", "+") {
