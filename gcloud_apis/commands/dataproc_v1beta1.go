...
import (
	...
	api_client "github.com/GoogleCloudPlatform/gcloud/gcloud_apis/clients/dataproc/v1beta1"
...
func Dataproc_v1beta1_ProjectsClustersAgentsCreate(context Context, args ...string) error {
	...
	service := api_client.NewProjectsClustersAgentsService(api_service)
	...
	param_clusterUuid, err := commands_util.ConvertValue_string(paramValues[1])
	if err != nil {
		return err
	}
	param_agentId, err := commands_util.ConvertValue_string(paramValues[2])
	if err != nil {
		return err
	}

	call := service.Create(param_projectId, param_clusterUuid, param_agentId,
		request,
	)

	var response *api_client.Agent
	response, err = call.Do()
	if err != nil {
		return err
	}
...
func Dataproc_v1beta1_ProjectsClustersAgentsDelete(context Context, args ...string) error {
	...
	call := service.Delete(param_projectId, param_clusterUuid, param_agentId)
...
func Dataproc_v1beta1_ProjectsClustersAgentsGet(context Context, args ...string) error {
	...
	call := service.Get(param_projectId, param_clusterUuid, param_agentId)
...
func Dataproc_v1beta1_ProjectsClustersAgentsList(context Context, args ...string) error {
	...
	call := service.List(param_projectId, param_clusterUuid)
	...
	var response *api_client.ListAgentsResponse
	response, err = call.Do()
	if err != nil {
		return err
	}
...
func Dataproc_v1beta1_ProjectsClustersAgentsUpdate(context Context, args ...string) error {
	...
	call := service.Update(param_projectId, param_clusterUuid, param_agentId,
		request,
	)
...
func Dataproc_v1beta1_ProjectsClustersTasksLease(context Context, args ...string) error {
	...
	service := api_client.NewProjectsClustersTasksService(api_service)
	...
	request := &api_client.LeaseTasksRequest{}
	if len(args) == 2 {
		err = commands_util.PopulateRequestFromFilename(&request, args[1])
		if err != nil {
			return err
	...
	call := service.Lease(param_projectId, param_clusterUuid,
		request,
	)

	var response *api_client.LeaseTasksResponse
	response, err = call.Do()
	if err != nil {
		return err
	}
...
func Dataproc_v1beta1_ProjectsClustersTasksReport(context Context, args ...string) error {
	...
	request := &api_client.ReportTaskStatusRequest{}
	if len(args) == 2 {
		err = commands_util.PopulateRequestFromFilename(&request, args[1])
		if err != nil {
			return err
	...
	param_taskId, err := commands_util.ConvertValue_string(paramValues[2])
	if err != nil {
		return err
	}

	call := service.Report(param_projectId, param_clusterUuid, param_taskId,
		request,
	)

	var response *api_client.ReportTaskStatusResponse
	response, err = call.Do()
	if err != nil {
		return err
	}
