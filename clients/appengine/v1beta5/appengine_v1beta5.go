...
// Usage example:
//
//   import "github.com/skelterjohn/gcloud_apis/clients/appengine/v1beta5"
//   ...
...
type ApiConfigHandler struct {
	...
	// "accounts.google.com". The user is redirected back to the
	// application URL after signing in or creating an account.
	//   "AUTH_FAIL_ACTION_UNAUTHORIZED" - Rejects request with an`401` HTTP
	...
	//   "LOGIN_ADMIN" - If the user is not signed in, the
	// `auth_fail_action` is taken.
	// In addition, if the user is not an administrator for the
	// application, they are given an error message regardless
	// of
	// `auth_fail_action`. If the user is an administrator, the
	// handler
	// proceeds.
	//   "LOGIN_REQUIRED" - If the user has signed in, the handler proceeds
	// normally. Otherwise, the
	// action given in `auth_fail_action` is taken.
...
type Application struct {
	...
	// storing files
	// associated with this application. This bucket is associated with
	// the
	...
	// will run out of data centers in the chosen location, which is also
	// where
	...
	// Name: Full path to the Application resource in the API.
	// Example: `apps/myapp`.
	//
	// @OutputOnly
...
type AutomaticScaling struct {
	// CoolDownPeriod: Amount of time that
	// the
	// [Autoscaler](https://cloud.google.com/compute/docs/autoscaler/)
	// sh
	// ould wait between changes to the number of virtual machines.
...
// becomes
// idle. Basic scaling is ideal for work that is intermittent or driven
// by
// user activity.
...
type Deployment struct {
	// Container: A Docker image that App Engine uses the run the
	// version.
	...
	// included
	// as part of this version. All files must be readable using
	// the
	...
	// one source reference per version if source code is distributed
	// among
...
// Unhealthy instances
// are killed and replaced with new instances. Only applicable
// for
...
type HealthCheck struct {
	...
	// Host: Host header to send when performing an HTTP health
	// check.
...
type Instance struct {
	...
	// AverageLatency: Average latency (ms) over the last
	// minute.
	//
	// @OutputOnly
	AverageLatency int64 `json:"averageLatency,omitempty"`

	// Errors: Number of errors since this instance was
	// started.
	//
	// @OutputOnly
	Errors int64 `json:"errors,omitempty"`

	// Id: Relative name of the instance within the version.
	// Example: `instance-1`.
	//
	// @OutputOnly
	Id string `json:"id,omitempty"`

	// MemoryUsage: Total memory in use (bytes).
	//
	// @OutputOnly
	MemoryUsage int64 `json:"memoryUsage,omitempty,string"`

	// Name: Full path to the Instance resource in the API.
	// Example:
	...
	// StartTimestamp: Time that this instance was started.
	//
	// @OutputOnly
...
type OperationMetadata1 struct {
	// EndTime: Timestamp that this operation completed.
	//
	// @OutputOnly
	EndTime string `json:"endTime,omitempty"`

	// InsertTime: Timestamp that this operation was created.
	//
	// @OutputOnly
	InsertTime string `json:"insertTime,omitempty"`

	// Method: API method that initiated this operation.
	// Example:
	...
	// User: User who requested this operation.
	//
	// @OutputOnly
...
type OperationMetadataV1 struct {
	// EndTime: Time that this operation completed.
	//
	// @OutputOnly
	EndTime string `json:"endTime,omitempty"`

	// InsertTime: Time that this operation was created.
	//
	// @OutputOnly
	InsertTime string `json:"insertTime,omitempty"`
...
type OperationMetadataV1Beta5 struct {
	...
	// Method: API method name that initiated this operation.
	// Example:
...
// For example, an application that handles customer requests
// might
// include separate services to handle other tasks such as API
// requests
// from mobile devices or backend data analysis. Each service has
// a
// collection of versions that define a specific set of code used
// to
// implement the functionality of that service.
type Module struct {
	// Id: Relative name of the service within the application.
	// Example: `default`.
	//
	// @OutputOnly
	Id string `json:"id,omitempty"`

	// Name: Full path to the Service resource in the API.
	// Example: `apps/myapp/services/default`.
	//
	// @OutputOnly
	Name string `json:"name,omitempty"`

	// Split: Mapping that defines fractional HTTP traffic diversion
	// to
...
type SourceReference struct {
	// Repository: URI string identifying the repository.
	...
	// revision.
	// Aliases that include tags or branch names are not allowed.
...
// URL, such as images, CSS
// stylesheets, or JavaScript source files. Static file handlers
// describe which
// files in the application directory are static files, and which URLs
// serve
// them.
type StaticFilesHandler struct {
	...
	// Path: Path to the static files matched by the URL pattern, from
	// the
...
// single service. Traffic
// splits define how traffic directed to the service is assigned to
// versions.
type TrafficSplit struct {
	...
	// have any traffic allocation. Services that have traffic
	// allocated
	// cannot be deleted until either the service is deleted or
	// their traffic allocation is removed. Allocations must sum to 1.
	// Up to two decimal place precision is supported for IP-based splits
	// and
	...
	// "GOOGAPPUID." The cookie
	// must be set by the application itself or else no diversion will
	// occur.
...
// App Engine can
// handle URLs by executing application code, or by serving static
// files
...
type UrlMap struct {
	...
	// Script: Executes a script to handle the request that matches this
	// URL
	// pattern.
...
type Version struct {
	// ApiConfig: Serving configuration for
	// [Google Cloud
	// Endpoints](https://cloud.google.com/appengine/docs/python/endpoints/).
	//
	//
	...
	// CreationTime: Time that this version was created.
	//
	// @OutputOnly
	...
	// corresponding
	// [StaticFilesHandler](https://cloud.google.com/appengine/
	// docs/admin-api/reference/rest/v1/apps.services.versions#staticfileshan
	// dler)
	...
	// applied to incoming
	// requests. The first matching URL handles the request and other
	// request
	...
	// instances are
	// be stopped and replaced with new instances. Only applicable for
	// VM
	// runtimes.
	//
	// Only returned in `GET` requests if `view=FULL` is set.
	...
	// Id: Relative name of the version within the module. Example:
	// `v1`.
	...
	// notifications when a client connects or
	...
	// Name: Full path to the Version resource in the API.
	// Example:
...
// project.
// This requires a project that excludes an App Engine application.
// For
// details about creating a project without an application, see
// the
// [Google Cloud Resource Manager create project
...
// Note: This parameter will be deprecated in a future version of the
// API.
...
func (c *AppsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta5/{+name}")
	urls += "?" + c.urlParams_.Encode()
...
func (r *AppsLocationsService) Get(name string) *AppsLocationsGetCall {
...
// service.
func (r *AppsLocationsService) List(name string) *AppsLocationsListCall {
...
func (c *AppsLocationsListCall) doRequest(alt string) (*http.Response, error) {
	...
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta5/{+name}/locations")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
func (c *AppsOperationsListCall) doRequest(alt string) (*http.Response, error) {
	...
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta5/{+name}/operations")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
func (r *AppsServicesService) Delete(name string) *AppsServicesDeleteCall {
...
func (c *AppsServicesDeleteCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the resource requested. Example: `apps/myapp/services/default`.",
	//       "location": "path",
...
func (r *AppsServicesService) Get(name string) *AppsServicesGetCall {
...
func (r *AppsServicesService) List(name string) *AppsServicesListCall {
...
func (c *AppsServicesListCall) doRequest(alt string) (*http.Response, error) {
	...
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta5/{+name}/services")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
func (c *AppsServicesListCall) Do(opts ...googleapi.CallOption) (*ListServicesResponse, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the resource requested. Example: `apps/myapp`.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]*$",
	//       "required": true,
	//       "type": "string"
...
func (r *AppsServicesService) Patch(name string, service *Service) *AppsServicesPatchCall {
...
// `true` to gradually shift traffic from one version to another
...
// rest/v1beta5/apps.services.versions#inboundservicetype)
// and
// [automatic
//
// scaling](https://cloud.google.com/appengine/docs/admin-api/reference/r
// est/v1beta5/apps.services.versions#automaticscaling).
// You must specify
// the
// [`shardBy`](https://cloud.google.com/appengine/docs/admin-api/refe
// rence/rest/v1beta5/apps.services#shardby)
// field in the Service resource. Gradual traffic migration is
// not
// supported in the App Engine flexible environment. For examples,
// see
...
func (c *AppsServicesPatchCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//     },
	//     "migrateTraffic": {
	//       "description": "Set to `true` to gradually shift traffic from one version to another\nsingle version. By default, traffic is shifted immediately.\nFor gradual traffic migration, the target version\nmust be located within instances that are configured for both\n[warmup requests](https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta5/apps.services.versions#inboundservicetype)\nand\n[automatic scaling](https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta5/apps.services.versions#automaticscaling).\nYou must specify the\n[`shardBy`](https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta5/apps.services#shardby)\nfield in the Service resource. Gradual traffic migration is not\nsupported in the App Engine flexible environment. For examples, see\n[Migrating and Splitting Traffic](https://cloud.google.com/appengine/docs/admin-api/migrating-splitting-traffic).",
	//       "location": "query",
	//       "type": "boolean"
	//     },
	//     "name": {
	//       "description": "Name of the resource to update. Example: `apps/myapp/services/default`.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]*/services/[^/]*$",
	//       "required": true,
	//       "type": "string"
...
func (r *AppsServicesVersionsService) Create(name string, version *Version) *AppsServicesVersionsCreateCall {
...
func (c *AppsServicesVersionsCreateCall) doRequest(alt string) (*http.Response, error) {
	...
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta5/{+name}/versions")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
func (r *AppsServicesVersionsService) Delete(name string) *AppsServicesVersionsDeleteCall {
...
func (c *AppsServicesVersionsDeleteCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the resource requested. Example:\n`apps/myapp/services/default/versions/v1`.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]*/services/[^/]*/versions/[^/]*$",
	//       "required": true,
	//       "type": "string"
	//     }
	//   },
...
// Get: Gets the specified Version resource.
// By default, only a `BASIC_VIEW` will be returned.
// Specify the `FULL_VIEW` parameter to get the full resource.
func (r *AppsServicesVersionsService) Get(name string) *AppsServicesVersionsGetCall {
...
func (r *AppsServicesVersionsService) List(name string) *AppsServicesVersionsListCall {
...
// You can specify the following fields depending on the App
// Engine
...
// App
//   Engine standard environment.
func (r *AppsServicesVersionsService) Patch(name string, version *Version) *AppsServicesVersionsPatchCall {
...
func (c *AppsServicesVersionsPatchCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//     },
	//     "name": {
	//       "description": "Name of the resource to update. Example:\n`apps/myapp/services/default/versions/1`.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]*/services/[^/]*/versions/[^/]*$",
	//       "required": true,
	//       "type": "string"
...
// SSH
// command to connect to the virtual machine where the instance
// lives.
// While in "debug mode", the instance continues to serve live
// traffic.
// You should delete the instance when you are done debugging and
// then
...
//
// Only applicable for instances in App Engine flexible environment.
func (r *AppsServicesVersionsInstancesService) Debug(name string, debuginstancerequest *DebugInstanceRequest) *AppsServicesVersionsInstancesDebugCall {
...
func (c *AppsServicesVersionsInstancesDebugCall) doRequest(alt string) (*http.Response, error) {
	...
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta5/{+name}:debug")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
func (c *AppsServicesVersionsInstancesDebugCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//       "description": "Name of the resource requested. Example:\n`apps/myapp/services/default/versions/v1/instances/instance-1`.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]*/services/[^/]*/versions/[^/]*/instances/[^/]*$",
	//       "required": true,
	//       "type": "string"
	//     }
	//   },
	//   "path": "v1beta5/{+name}:debug",
	//   "request": {
...
func (r *AppsServicesVersionsInstancesService) Delete(name string) *AppsServicesVersionsInstancesDeleteCall {
...
func (r *AppsServicesVersionsInstancesService) Get(name string) *AppsServicesVersionsInstancesGetCall {
...
func (r *AppsServicesVersionsInstancesService) List(name string) *AppsServicesVersionsInstancesListCall {
...
func (c *AppsServicesVersionsInstancesListCall) doRequest(alt string) (*http.Response, error) {
	...
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1beta5/{+name}/instances")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
