...
func (r *AppsService) Patch(name string, application *Application) *AppsPatchCall {
...
func (c *AppsPatchCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//     },
	//     "name": {
	//       "description": "Name of the Application resource to update. Example: apps/myapp.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (c *AppsServicesVersionsCreateCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the resource to update. For example: \"apps/myapp/services/default\".",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+/services/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (c *AppsServicesVersionsDeleteCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the resource requested. Example: apps/myapp/services/default/versions/v1.",
	//       "location": "path",
...
func (c *AppsServicesVersionsPatchCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//     },
	//     "name": {
	//       "description": "Name of the resource to update. Example: apps/myapp/services/default/versions/1.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+/services/[^/]+/versions/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (c *AppsServicesVersionsInstancesDebugCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the resource requested. Example: apps/myapp/services/default/versions/v1/instances/instance-1.",
	//       "location": "path",
...
func (c *AppsServicesVersionsInstancesDeleteCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the resource requested. For example: \"apps/myapp/services/default/versions/v1/instances/instance-1\".",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+/services/[^/]+/versions/[^/]+/instances/[^/]+$",
	//       "required": true,
	//       "type": "string"
