...
// Usage example:
//
//   import "github.com/skelterjohn/gcloud_apis/clients/appengine/v1"
//   ...
...
func (c *AppsGetCall) Do(opts ...googleapi.CallOption) (*Application, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the Application resource to get. Example: apps/myapp.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (r *AppsService) Repair(name string, repairapplicationrequest *RepairApplicationRequest) *AppsRepairCall {
...
func (c *AppsRepairCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//   "parameters": {
	//     "name": {
	//       "description": "Name of the application to repair. Example: apps/myapp",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (r *AppsServicesService) List(parent string) *AppsServicesListCall {
...
func (r *AppsServicesVersionsService) Create(parent string, version *Version) *AppsServicesVersionsCreateCall {
...
func (c *AppsServicesVersionsCreateCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	...
	//   "parameters": {
	//     "parent": {
	//       "description": "Name of the parent resource to create this version under. Example: apps/myapp/services/default.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+/services/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (r *AppsServicesVersionsService) List(parent string) *AppsServicesVersionsListCall {
...
func (c *AppsServicesVersionsListCall) Do(opts ...googleapi.CallOption) (*ListVersionsResponse, error) {
	...
	//     },
	//     "parent": {
	//       "description": "Name of the parent Service resource. Example: apps/myapp/services/default.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+/services/[^/]+$",
	//       "required": true,
	//       "type": "string"
...
func (c *AppsServicesVersionsInstancesDebugCall) doRequest(alt string) (*http.Response, error) {
	...
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/{+name}:debug")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
func (c *AppsServicesVersionsInstancesListCall) Do(opts ...googleapi.CallOption) (*ListInstancesResponse, error) {
	...
	//     },
	//     "parent": {
	//       "description": "Name of the parent Version resource. Example: apps/myapp/services/default/versions/v1.",
	//       "location": "path",
	//       "pattern": "^apps/[^/]+/services/[^/]+/versions/[^/]+$",
	//       "required": true,
	//       "type": "string"
