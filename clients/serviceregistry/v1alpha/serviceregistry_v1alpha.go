...
const apiId = "serviceregistry:v1alpha"
const apiName = "serviceregistry"
const apiVersion = "v1alpha"
const basePath = "https://www.googleapis.com/serviceregistry/v1alpha/projects/"
...
// EndpointAddress: Information about a single address and the
// corresponding ports for an endpoint.
...
func (s *EndpointDnsIntegration) MarshalJSON() ([]byte, error) {
	type noMethod EndpointDnsIntegration
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}
