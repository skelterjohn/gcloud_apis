...
// Usage example:
//
//   import "github.com/skelterjohn/gcloud_apis/clients/dataproc/v1"
//   ...
...
// Cluster: Describes the identifying information, config, and status
// of
...
type ClusterConfig struct {
	...
	// for sharing generated
	// SSH keys and config. If you do not specify a staging bucket,
	// Cloud
	...
	// on
	// a master or worker node, as shown below using `curl` (you can also
	// use `wget`):
	//
...
type GceClusterConfig struct {
	...
	// subnetwork
	// enabled networks, and all off-cluster dependencies must be configured
	// to be
	...
	// Network" (see
	// [Using Subnetworks](/compute/docs/subnetworks) for more
	// information).
	// Example:
	...
	// (see
	// [Labeling
	// instances](/compute/docs/label-or-tag-resources#labeling_instances)).
...
// HadoopJob: A Cloud Dataproc job for running
// [Apache Hadoop
// MapReduce](https://hadoop.apache.org/docs/current/hadoop-mapreduce-cli
// ent/hadoop-mapreduce-client-core/MapReduceTutorial.html)
...
type HadoopJob struct {
	...
	// files to be copied
	// to the working directory of Hadoop drivers and distributed tasks.
	// Useful
...
type JobStatus struct {
	// Details: [Output-only] Optional job state details, such as an
	// error
...
// PySparkJob: A Cloud Dataproc job for running
// [Apache
...
type SoftwareConfig struct {
	...
	// files.
	//
	// Property keys are specified in `prefix:property` format, such
	// as
...
// <code>config.secondary_worker_config.num_instances</code>,
...
// <code>config.worker_config.num_instances</code>
// and <code>config.secondary_worker_config.num_instances</code> are the
// only
...
// after cancellation,
// call
// [regions/{region}/jobs.list](/dataproc/reference/rest/v1/projects
// .regions.jobs/list)
// or
// [regions/{region}/jobs.get](/dataproc/reference/rest/v1/projects.re
// gions.jobs/get).
