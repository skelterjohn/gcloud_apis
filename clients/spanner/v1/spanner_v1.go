...
// Usage example:
//
//   import "github.com/skelterjohn/gcloud_apis/clients/spanner/v1"
//   ...
...
type ExecuteSqlRequest struct {
	...
	Params ExecuteSqlRequestParams `json:"params,omitempty"`
...
type ExecuteSqlRequestParams interface{}
...
type PlanNode struct {
	...
	// per
	// execution etc.
	ExecutionStats PlanNodeExecutionStats `json:"executionStats,omitempty"`
	...
	//     }
	Metadata PlanNodeMetadata `json:"metadata,omitempty"`
...
type PlanNodeExecutionStats interface{}

type PlanNodeMetadata interface{}
...
type ResultSetStats struct {
	...
	//       "cpu_time": "1.19 secs"
	//     }
	QueryStats ResultSetStatsQueryStats `json:"queryStats,omitempty"`
...
type ResultSetStatsQueryStats interface{}
...
type ShortRepresentation struct {
	...
	// of
	// this node.
	Subqueries *ShortRepresentationSubqueries `json:"subqueries,omitempty"`
...
// ShortRepresentationSubqueries: A mapping of (subquery variable name)
// -> (subquery node id) for cases
// where the `description` string of this node references a
// `SCALAR`
// subquery contained in the expression subtree rooted at this node.
// The
...
// of
// this node.
type ShortRepresentationSubqueries struct {
}
