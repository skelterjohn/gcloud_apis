...
func NewServicesAccessPolicyService(s *Service) *ServicesAccessPolicyService {
	rs := &ServicesAccessPolicyService{s: s}
	return rs
}
...
func NewServicesCustomerSettingsService(s *Service) *ServicesCustomerSettingsService {
	rs := &ServicesCustomerSettingsService{s: s}
	return rs
}
...
func NewServicesProjectSettingsService(s *Service) *ServicesProjectSettingsService {
	rs := &ServicesProjectSettingsService{s: s}
	return rs
}
...
func (s *CompositeOperationMetadata) MarshalJSON() ([]byte, error) {
	type noMethod CompositeOperationMetadata
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}
...
func (s *ConvertConfigRequest) MarshalJSON() ([]byte, error) {
	type noMethod ConvertConfigRequest
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}
...
func (s *ConvertConfigResponse) MarshalJSON() ([]byte, error) {
	type noMethod ConvertConfigResponse
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}
...
// EffectiveQuotaGroup: An effective quota group contains both the
// metadata for a quota group
// as derived from the service config, and the effective limits in
// that
// group as calculated from producer and consumer overrides together
// with
// service defaults.
...
func (s *EffectiveQuotaGroup) MarshalJSON() ([]byte, error) {
	type noMethod EffectiveQuotaGroup
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// EffectiveQuotaLimit: An effective quota limit contains the metadata
// for a quota limit
// as derived from the service config, together with fields that
// describe
...
func (s *EffectiveQuotaLimit) MarshalJSON() ([]byte, error) {
	type noMethod EffectiveQuotaLimit
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// EffectiveQuotaLimit2: An effective quota limit contains the metadata
// for a quota limit
// as derived from the service config, together with fields that
// describe
// the effective limit value and what overrides can be applied to
// it.
// This is used only for quota limits that are grouped by metrics
// instead of
// quota groups.
...
func (s *EffectiveQuotaLimit2) MarshalJSON() ([]byte, error) {
	type noMethod EffectiveQuotaLimit2
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// EffectiveQuotasForMetric: Effective quotas for a metric. It contains
// both the metadata for
// the metric as defined in the service config, and the effective limits
// for
// quota limits defined on the metric as calculated from service
// default,
// producer and consumer overrides, and adjusted by the reputation tier
// of the
// user.
// This is used only for quota limits that are grouped by metrics
// instead of
...
func (s *EffectiveQuotasForMetric) MarshalJSON() ([]byte, error) {
	type noMethod EffectiveQuotasForMetric
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}
...
// ProjectSettings: Settings that control how a consumer project uses a
// service.
...
func (s *QueryUserAccessResponse) MarshalJSON() ([]byte, error) {
	type noMethod QueryUserAccessResponse
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// QuotaBucket: The quota limit value and current usage for a quota
// bucket.
...
// QuotaInfo: Metadata about an individual quota, containing usage and
// limit information.
...
type QuotaLimit struct {
	...
	// Name: Name of the quota limit.  Must be unique within the quota
	// group.
	// This name is used to refer to the limit when overriding the limit
	// on
	// a per-project basis.  If a name is not provided, it will be
	// generated
...
// QuotaLimitOverride: Specifies a custom quota limit that is applied
// for this consumer project.
...
func (s *QuotaLimitOverride) MarshalJSON() ([]byte, error) {
	type noMethod QuotaLimitOverride
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// QuotaSettings: Per-consumer overrides for quota settings. See
// google/api/quota.proto
// for the corresponding service configuration which provides the
// default
// values.
...
func (s *QuotaSettings) MarshalJSON() ([]byte, error) {
	type noMethod QuotaSettings
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// QuotaUsage: Specifies the used quota amount for a quota limit at a
// particular time.
...
// ServiceAccessList: List of users and groups that are granted access
// to a service or visibility
// label.
type ServiceAccessList struct {
	// Members: Members that are granted access.
	//
	// - "user:{$user_email}" - Grant access to an individual user
	// - "group:{$group_email}" - Grant access to direct members of the
	// group
	// - "domain:{$domain}" - Grant access to all members of the domain. For
	// now,
	//      domain membership check will be similar to Devconsole/TT check:
	//      compare domain part of the user email to configured domain
	// name.
	//      When IAM integration is complete, this will be replaced with
	// IAM
	//      check.
	Members []string `json:"members,omitempty"`
...
func (s *ServiceAccessList) MarshalJSON() ([]byte, error) {
	type noMethod ServiceAccessList
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// ServiceAccessPolicy: Policy describing who can access a service and
// any visibility labels on that
// service.
type ServiceAccessPolicy struct {
	// AccessList: ACL for access to the unrestricted surface of the
	// service.
	AccessList *ServiceAccessList `json:"accessList,omitempty"`

	// ServiceName: The service protected by this policy.
	ServiceName string `json:"serviceName,omitempty"`

	// VisibilityLabelAccessLists: ACLs for access to restricted parts of
	// the service.  The map key is the
	// visibility label that is being controlled.  Note that access to any
	// label
	// also implies access to the unrestricted surface.
	VisibilityLabelAccessLists map[string]ServiceAccessList `json:"visibilityLabelAccessLists,omitempty"`

	// ServerResponse contains the HTTP response code and headers from the
	// server.
	googleapi.ServerResponse `json:"-"`

	// ForceSendFields is a list of field names (e.g. "AccessList") to
	// unconditionally include in API requests. By default, fields with
	// empty values are omitted from API requests. However, any non-pointer,
	// non-interface field appearing in ForceSendFields will be sent to the
	// server regardless of whether the field is empty or not. This may be
...
func (s *ServiceAccessPolicy) MarshalJSON() ([]byte, error) {
	type noMethod ServiceAccessPolicy
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}
...
func (s *UsageSettings) MarshalJSON() ([]byte, error) {
	type noMethod UsageSettings
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// VariableTermQuota: A variable term quota is a bucket of tokens that
// is consumed over a
// specified (usually long) time period. When present, it overrides
// any
// "1d" duration per-project quota specified on the group.
//
// Variable terms run from midnight to midnight, start_date to
// end_date
...
func (s *VariableTermQuota) MarshalJSON() ([]byte, error) {
	type noMethod VariableTermQuota
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}
...
func (s *VisibilitySettings) MarshalJSON() ([]byte, error) {
	type noMethod VisibilitySettings
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}
...
func (c *OperationsGetCall) doRequest(alt string) (*http.Response, error) {
	...
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/operations/{operationsId}")
...
// method id "servicemanagement.services.convertConfig":

type ServicesConvertConfigCall struct {
	s                    *Service
	convertconfigrequest *ConvertConfigRequest
	urlParams_           gensupport.URLParams
	ctx_                 context.Context
}

// ConvertConfig: DEPRECATED. `SubmitConfigSource` with
// `validate_only=true` will provide
...
func (r *ServicesService) ConvertConfig(convertconfigrequest *ConvertConfigRequest) *ServicesConvertConfigCall {
	c := &ServicesConvertConfigCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.convertconfigrequest = convertconfigrequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesConvertConfigCall) Fields(s ...googleapi.Field) *ServicesConvertConfigCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesConvertConfigCall) Context(ctx context.Context) *ServicesConvertConfigCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesConvertConfigCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.convertconfigrequest)
	if err != nil {
		return nil, err
	}
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/services:convertConfig")
	urls += "?" + c.urlParams_.Encode()
...
// Do executes the "servicemanagement.services.convertConfig" call.
// Exactly one of *ConvertConfigResponse or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *ConvertConfigResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ServicesConvertConfigCall) Do(opts ...googleapi.CallOption) (*ConvertConfigResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// ConsumerProjectId sets the optional parameter "consumerProjectId": If
// project_settings is expanded, return settings for the
// specified
// consumer project.
func (c *ServicesGetCall) ConsumerProjectId(consumerProjectId string) *ServicesGetCall {
	c.urlParams_.Set("consumerProjectId", consumerProjectId)
	return c
}
...
// View sets the optional parameter "view": If project_settings is
// expanded, request only fields for the specified
// view.
//
// Possible values:
...
// method id "servicemanagement.services.getAccessPolicy":

type ServicesGetAccessPolicyCall struct {
	s            *Service
	serviceName  string
	urlParams_   gensupport.URLParams
	ifNoneMatch_ string
...
// GetAccessPolicy: Producer method to retrieve current policy.
func (r *ServicesService) GetAccessPolicy(serviceName string) *ServicesGetAccessPolicyCall {
	c := &ServicesGetAccessPolicyCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesGetAccessPolicyCall) Fields(s ...googleapi.Field) *ServicesGetAccessPolicyCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ServicesGetAccessPolicyCall) IfNoneMatch(entityTag string) *ServicesGetAccessPolicyCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesGetAccessPolicyCall) Context(ctx context.Context) *ServicesGetAccessPolicyCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesGetAccessPolicyCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	...
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/services/{serviceName}/accessPolicy")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
// Do executes the "servicemanagement.services.getAccessPolicy" call.
// Exactly one of *ServiceAccessPolicy or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *ServiceAccessPolicy.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ServicesGetAccessPolicyCall) Do(opts ...googleapi.CallOption) (*ServiceAccessPolicy, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
func (c *ServicesGetIamPolicyCall) doRequest(alt string) (*http.Response, error) {
	...
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/services/{servicesId}:getIamPolicy")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
// Category sets the optional parameter "category": Include services
// only in the specified category. Supported categories
// are
// servicemanagement.googleapis.com/categories/google-services
// or
...
// ConsumerProjectId sets the optional parameter "consumerProjectId":
// Include services consumed by the specified project.
//
...
// method id "servicemanagement.services.patch":
...
// Do executes the "servicemanagement.services.patch" call.
// Exactly one of *Operation or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified
...
func (c *ServicesSetIamPolicyCall) doRequest(alt string) (*http.Response, error) {
	...
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/services/{servicesId}:setIamPolicy")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
func (c *ServicesTestIamPermissionsCall) doRequest(alt string) (*http.Response, error) {
	...
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/services/{servicesId}:testIamPermissions")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
// method id "servicemanagement.services.update":
...
// Update: Updates the configuration of a service.  If the specified
// service does not
// already exist, then it is created.
//
// Operation<response: ManagedService>
func (r *ServicesService) Update(serviceName string, managedservice *ManagedService) *ServicesUpdateCall {
	c := &ServicesUpdateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
	c.managedservice = managedservice
	return c
}
...
// Update mask has been deprecated on UpdateService service method.
// Please
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesUpdateCall) Fields(s ...googleapi.Field) *ServicesUpdateCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesUpdateCall) Context(ctx context.Context) *ServicesUpdateCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesUpdateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.managedservice)
...
// Do executes the "servicemanagement.services.update" call.
// Exactly one of *Operation or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified
// to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ServicesUpdateCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "servicemanagement.services.updateAccessPolicy":

type ServicesUpdateAccessPolicyCall struct {
	s                   *Service
	serviceName         string
...
// UpdateAccessPolicy: Producer method to update the current policy.
// This method will return an
// error if the policy is too large (more than 50 entries across all
// lists).
func (r *ServicesService) UpdateAccessPolicy(serviceName string, serviceaccesspolicy *ServiceAccessPolicy) *ServicesUpdateAccessPolicyCall {
	c := &ServicesUpdateAccessPolicyCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
	c.serviceaccesspolicy = serviceaccesspolicy
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesUpdateAccessPolicyCall) Fields(s ...googleapi.Field) *ServicesUpdateAccessPolicyCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesUpdateAccessPolicyCall) Context(ctx context.Context) *ServicesUpdateAccessPolicyCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesUpdateAccessPolicyCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.serviceaccesspolicy)
	if err != nil {
		return nil, err
	}
	reqHeaders.Set("Content-Type", "application/json")
...
// Do executes the "servicemanagement.services.updateAccessPolicy" call.
// Exactly one of *ServiceAccessPolicy or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *ServiceAccessPolicy.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ServicesUpdateAccessPolicyCall) Do(opts ...googleapi.CallOption) (*ServiceAccessPolicy, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// Query: Method to query the accessibility of a service and any
// associated
// visibility labels for a specified user.
//
// Members of the producer project may call this method and specify any
// user.
//
// Any user may call this method, but must specify their own email
// address.
// In this case the method will return NOT_FOUND if the user has no
// access to
// the service.
func (r *ServicesAccessPolicyService) Query(serviceName string) *ServicesAccessPolicyQueryCall {
	c := &ServicesAccessPolicyQueryCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
	return c
}

// UserEmail sets the optional parameter "userEmail": The user to query
// access for.
func (c *ServicesAccessPolicyQueryCall) UserEmail(userEmail string) *ServicesAccessPolicyQueryCall {
	c.urlParams_.Set("userEmail", userEmail)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesAccessPolicyQueryCall) Fields(s ...googleapi.Field) *ServicesAccessPolicyQueryCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesAccessPolicyQueryCall) Context(ctx context.Context) *ServicesAccessPolicyQueryCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesAccessPolicyQueryCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/services/{serviceName}/accessPolicy:query")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
// Do executes the "servicemanagement.services.accessPolicy.query" call.
// Exactly one of *QueryUserAccessResponse or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *QueryUserAccessResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ServicesAccessPolicyQueryCall) Do(opts ...googleapi.CallOption) (*QueryUserAccessResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// Get: Retrieves the settings that control the specified customer's
// usage of the
// service.
func (r *ServicesCustomerSettingsService) Get(serviceName string, customerId string) *ServicesCustomerSettingsGetCall {
	c := &ServicesCustomerSettingsGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
...
// Expand sets the optional parameter "expand": Fields to expand in any
// results.
func (c *ServicesCustomerSettingsGetCall) Expand(expand string) *ServicesCustomerSettingsGetCall {
	c.urlParams_.Set("expand", expand)
	return c
}

// View sets the optional parameter "view": Request only fields for the
// specified view.
//
// Possible values:
//   "PROJECT_SETTINGS_VIEW_UNSPECIFIED"
...
//   "PRODUCER_VIEW"
//   "ALL"
func (c *ServicesCustomerSettingsGetCall) View(view string) *ServicesCustomerSettingsGetCall {
	c.urlParams_.Set("view", view)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesCustomerSettingsGetCall) Fields(s ...googleapi.Field) *ServicesCustomerSettingsGetCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ServicesCustomerSettingsGetCall) IfNoneMatch(entityTag string) *ServicesCustomerSettingsGetCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesCustomerSettingsGetCall) Context(ctx context.Context) *ServicesCustomerSettingsGetCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesCustomerSettingsGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	...
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/services/{serviceName}/customerSettings/{customerId}")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
// Do executes the "servicemanagement.services.customerSettings.get" call.
...
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ServicesCustomerSettingsGetCall) Do(opts ...googleapi.CallOption) (*CustomerSettings, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "servicemanagement.services.customerSettings.patch":
...
// Patch: Patches specified subset of the settings that control the
// specified
// customer's usage of the service.  Attempts to update a field
// not
// controlled by the caller will result in an access denied
// error.
//
...
func (r *ServicesCustomerSettingsService) Patch(serviceName string, customerId string, customersettings *CustomerSettings) *ServicesCustomerSettingsPatchCall {
	c := &ServicesCustomerSettingsPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
	c.customerId = customerId
...
// specifying which fields are to be updated.
func (c *ServicesCustomerSettingsPatchCall) UpdateMask(updateMask string) *ServicesCustomerSettingsPatchCall {
	c.urlParams_.Set("updateMask", updateMask)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesCustomerSettingsPatchCall) Fields(s ...googleapi.Field) *ServicesCustomerSettingsPatchCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesCustomerSettingsPatchCall) Context(ctx context.Context) *ServicesCustomerSettingsPatchCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesCustomerSettingsPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
...
// Do executes the "servicemanagement.services.customerSettings.patch" call.
// Exactly one of *Operation or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified
// to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ServicesCustomerSettingsPatchCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "servicemanagement.services.projectSettings.get":
...
// Get: Retrieves the settings that control the specified consumer
// project's usage
// of the service.
func (r *ServicesProjectSettingsService) Get(serviceName string, consumerProjectId string) *ServicesProjectSettingsGetCall {
	c := &ServicesProjectSettingsGetCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
	c.consumerProjectId = consumerProjectId
	return c
}
...
// - `operations`
// - `quota_usage`
func (c *ServicesProjectSettingsGetCall) Expand(expand string) *ServicesProjectSettingsGetCall {
	c.urlParams_.Set("expand", expand)
	return c
}

// View sets the optional parameter "view": Request only the fields for
// the specified view.
//
// Possible values:
//   "PROJECT_SETTINGS_VIEW_UNSPECIFIED"
...
//   "PRODUCER_VIEW"
//   "ALL"
func (c *ServicesProjectSettingsGetCall) View(view string) *ServicesProjectSettingsGetCall {
	c.urlParams_.Set("view", view)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesProjectSettingsGetCall) Fields(s ...googleapi.Field) *ServicesProjectSettingsGetCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// request. Use googleapi.IsNotModified to check whether the response
// error from Do is the result of In-None-Match.
func (c *ServicesProjectSettingsGetCall) IfNoneMatch(entityTag string) *ServicesProjectSettingsGetCall {
	c.ifNoneMatch_ = entityTag
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesProjectSettingsGetCall) Context(ctx context.Context) *ServicesProjectSettingsGetCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesProjectSettingsGetCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	if c.ifNoneMatch_ != "" {
		reqHeaders.Set("If-None-Match", c.ifNoneMatch_)
	...
	var body io.Reader = nil
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/services/{serviceName}/projectSettings/{consumerProjectId}")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("GET", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
		"serviceName":       c.serviceName,
		"consumerProjectId": c.consumerProjectId,
	})
	if c.ctx_ != nil {
		return ctxhttp.Do(c.ctx_, c.s.client, req)
	}
...
// Do executes the "servicemanagement.services.projectSettings.get" call.
...
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *ServicesProjectSettingsGetCall) Do(opts ...googleapi.CallOption) (*ProjectSettings, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "servicemanagement.services.projectSettings.patch":
...
// Patch: Updates specified subset of the settings that control the
// specified
// consumer project's usage of the service.  Attempts to update a field
// not
// controlled by the caller will result in an access denied
// error.
//
...
func (r *ServicesProjectSettingsService) Patch(serviceName string, consumerProjectId string, projectsettings *ProjectSettings) *ServicesProjectSettingsPatchCall {
	c := &ServicesProjectSettingsPatchCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
	c.consumerProjectId = consumerProjectId
...
// UpdateMask sets the optional parameter "updateMask": The field mask
// specifying which fields are to be updated.
func (c *ServicesProjectSettingsPatchCall) UpdateMask(updateMask string) *ServicesProjectSettingsPatchCall {
	c.urlParams_.Set("updateMask", updateMask)
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesProjectSettingsPatchCall) Fields(s ...googleapi.Field) *ServicesProjectSettingsPatchCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesProjectSettingsPatchCall) Context(ctx context.Context) *ServicesProjectSettingsPatchCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesProjectSettingsPatchCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
...
// Do executes the "servicemanagement.services.projectSettings.patch" call.
// Exactly one of *Operation or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified
// to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ServicesProjectSettingsPatchCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "servicemanagement.services.projectSettings.update":
...
// Update: NOTE: Currently unsupported.  Use PatchProjectSettings
// instead.
//
// Updates the settings that control the specified consumer project's
// usage
// of the service.  Attempts to update a field not controlled by the
// caller
...
func (r *ServicesProjectSettingsService) Update(serviceName string, consumerProjectId string, projectsettings *ProjectSettings) *ServicesProjectSettingsUpdateCall {
	c := &ServicesProjectSettingsUpdateCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.serviceName = serviceName
	c.consumerProjectId = consumerProjectId
	c.projectsettings = projectsettings
	return c
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ServicesProjectSettingsUpdateCall) Fields(s ...googleapi.Field) *ServicesProjectSettingsUpdateCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ServicesProjectSettingsUpdateCall) Context(ctx context.Context) *ServicesProjectSettingsUpdateCall {
	c.ctx_ = ctx
	return c
}

func (c *ServicesProjectSettingsUpdateCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.projectsettings)
...
// Do executes the "servicemanagement.services.projectSettings.update" call.
// Exactly one of *Operation or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified
// to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ServicesProjectSettingsUpdateCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
...
// method id "servicemanagement.convertConfig":
...
func (r *V1Service) ConvertConfig(convertconfigrequest *ConvertConfigRequest) *V1ConvertConfigCall {
	c := &V1ConvertConfigCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.convertconfigrequest = convertconfigrequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *V1ConvertConfigCall) Fields(s ...googleapi.Field) *V1ConvertConfigCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *V1ConvertConfigCall) Context(ctx context.Context) *V1ConvertConfigCall {
	c.ctx_ = ctx
	return c
}

func (c *V1ConvertConfigCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.convertconfigrequest)
	...
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1:convertConfig")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.SetOpaque(req.URL)
...
// Do executes the "servicemanagement.convertConfig" call.
// Exactly one of *ConvertConfigResponse or error will be non-nil. Any
// non-2xx status code is an error. Response headers are in either
// *ConvertConfigResponse.ServerResponse.Header or (if a response was
// returned at all) in error.(*googleapi.Error).Header. Use
// googleapi.IsNotModified to check whether the returned error was
// because http.StatusNotModified was returned.
func (c *V1ConvertConfigCall) Do(opts ...googleapi.CallOption) (*ConvertConfigResponse, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
