...
// Usage example:
//
//   import "github.com/skelterjohn/gcloud_apis/clients/bio/v1"
//   ...
//   bioService, err := bio.New(oauthHttpClient)
package bio
...
const apiName = "bio"
const apiVersion = "v1"
const basePath = "https://bio.googleapis.com/"
...
func NewProjectsService(s *Service) *ProjectsService {
	...
	rs.Pipelines = NewProjectsPipelinesService(s)
	return rs
}
...
type ProjectsService struct {
	...
	Pipelines *ProjectsPipelinesService
}
...
func NewProjectsPipelinesService(s *Service) *ProjectsPipelinesService {
	rs := &ProjectsPipelinesService{s: s}
	return rs
}

type ProjectsPipelinesService struct {
	s *Service
}
...
// PipelineOptions: Common pipeline options.
type PipelineOptions struct {
	// ComputeZones: Google Compute Engine availability zones in which the
	// workflow should start
	// worker virtual machines, if any are needed for this particular
	// workflow.
	// Must be valid Google Compute Engine zone names, for example
	// "us-east1-d".
	ComputeZones []string `json:"computeZones,omitempty"`

	// Labels: User-settable labels. Applied to the Operation and any
	// associated pipeline
	// resources, e.g. GCE VMs (if any).
	Labels map[string]string `json:"labels,omitempty"`

	// RequestId: Optional. If non-empty then requests are idempotent in
	// that
	// sending a second RunWorkflowRequest with the same project_id and
	// request_id
	// will return the name of the same already-running operation, instead
	// of
	// starting another.
	// Do not reuse request_ids. Reusing a (project_id, request_id) for
	// a
	// different request will result in an error.
	// A common way of filling this value is with a random 64-bit number.
	RequestId string `json:"requestId,omitempty"`

	// ForceSendFields is a list of field names (e.g. "ComputeZones") to
	// unconditionally include in API requests. By default, fields with
	// empty values are omitted from API requests. However, any non-pointer,
	// non-interface field appearing in ForceSendFields will be sent to the
	// server regardless of whether the field is empty or not. This may be
...
func (s *PipelineOptions) MarshalJSON() ([]byte, error) {
	type noMethod PipelineOptions
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

type RunDeepVariantV1alphaRequest struct {
	// InputFastq1: List of Google Cloud Storage paths of forward strand
	// FASTQ.
	// The pairs of FASTQ files must occur at the same position in both
	// lists.
	// e.g.:
	//
	//   input_fastq1s = ['lane1_1.fastq', 'lane2_1.fastq',
	// 'lane3_1.fastq']
	//   input_fastq2s = ['lane1_2.fastq', 'lane2_2.fastq', 'lane3_2.fastq']
	InputFastq1 []string `json:"inputFastq1,omitempty"`

	// InputFastq2: List of Google Cloud Storage paths of reverse strand
	// FASTQ.
	// The pairs of FASTQ files must occur at the same position in both
	// lists.
	// e.g.:
	...
	// 'lane3_1.fastq']
	//   input_fastq2s = ['lane1_2.fastq', 'lane2_2.fastq', 'lane3_2.fastq']
	InputFastq2 []string `json:"inputFastq2,omitempty"`

	// Options: Common pipeline options.
	Options *PipelineOptions `json:"options,omitempty"`

	// OutputPath: Required. The Google Cloud Storage path for copying the
	// final output files.
	...
	// ForceSendFields is a list of field names (e.g. "InputFastq1") to
	// unconditionally include in API requests. By default, fields with
	// empty values are omitted from API requests. However, any non-pointer,
	// non-interface field appearing in ForceSendFields will be sent to the
	// server regardless of whether the field is empty or not. This may be
...
func (s *RunDeepVariantV1alphaRequest) MarshalJSON() ([]byte, error) {
	type noMethod RunDeepVariantV1alphaRequest
	raw := noMethod(*s)
	return gensupport.MarshalJSON(raw, s.ForceSendFields)
}

// RuntimeMetadata: Runtime metadata that will be populated in the
// runtime_metadata field
...
// method id "bio.projects.operations.cancel":
...
// Do executes the "bio.projects.operations.cancel" call.
...
// method id "bio.projects.operations.get":
...
// Do executes the "bio.projects.operations.get" call.
...
// method id "bio.projects.operations.list":
...
// Do executes the "bio.projects.operations.list" call.
...
// method id "bio.projects.pipelines.runDeepVariantV1alpha":

type ProjectsPipelinesRunDeepVariantV1alphaCall struct {
	s                            *Service
	projectId                    string
	rundeepvariantv1alpharequest *RunDeepVariantV1alphaRequest
	urlParams_                   gensupport.URLParams
	ctx_                         context.Context
}

// RunDeepVariantV1alpha: Run a DeepVariant pipeline.
func (r *ProjectsPipelinesService) RunDeepVariantV1alpha(projectId string, rundeepvariantv1alpharequest *RunDeepVariantV1alphaRequest) *ProjectsPipelinesRunDeepVariantV1alphaCall {
	c := &ProjectsPipelinesRunDeepVariantV1alphaCall{s: r.s, urlParams_: make(gensupport.URLParams)}
	c.projectId = projectId
	c.rundeepvariantv1alpharequest = rundeepvariantv1alpharequest
	return c
}
...
// https://developers.google.com/gdata/docs/2.0/basics#PartialResponse
// for more information.
func (c *ProjectsPipelinesRunDeepVariantV1alphaCall) Fields(s ...googleapi.Field) *ProjectsPipelinesRunDeepVariantV1alphaCall {
	c.urlParams_.Set("fields", googleapi.CombineFields(s))
	return c
}
...
// pending HTTP request will be aborted if the provided context is
// canceled.
func (c *ProjectsPipelinesRunDeepVariantV1alphaCall) Context(ctx context.Context) *ProjectsPipelinesRunDeepVariantV1alphaCall {
	c.ctx_ = ctx
	return c
}

func (c *ProjectsPipelinesRunDeepVariantV1alphaCall) doRequest(alt string) (*http.Response, error) {
	reqHeaders := make(http.Header)
	reqHeaders.Set("User-Agent", c.s.userAgent())
	var body io.Reader = nil
	body, err := googleapi.WithoutDataWrapper.JSONReader(c.rundeepvariantv1alpharequest)
	if err != nil {
		return nil, err
	}
	reqHeaders.Set("Content-Type", "application/json")
	c.urlParams_.Set("alt", alt)
	urls := googleapi.ResolveRelative(c.s.BasePath, "v1/projects/{projectId}/pipelines:runDeepVariantV1alpha")
	urls += "?" + c.urlParams_.Encode()
	req, _ := http.NewRequest("POST", urls, body)
	req.Header = reqHeaders
	googleapi.Expand(req.URL, map[string]string{
...
// Do executes the "bio.projects.pipelines.runDeepVariantV1alpha" call.
// Exactly one of *Operation or error will be non-nil. Any non-2xx
// status code is an error. Response headers are in either
// *Operation.ServerResponse.Header or (if a response was returned at
// all) in error.(*googleapi.Error).Header. Use googleapi.IsNotModified
// to check whether the returned error was because
// http.StatusNotModified was returned.
func (c *ProjectsPipelinesRunDeepVariantV1alphaCall) Do(opts ...googleapi.CallOption) (*Operation, error) {
	gensupport.SetOptions(c.urlParams_, opts...)
	res, err := c.doRequest("json")
	if res != nil && res.StatusCode == http.StatusNotModified {
		if res.Body != nil {
